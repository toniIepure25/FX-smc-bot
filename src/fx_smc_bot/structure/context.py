...
def build_structure_snapshot(
    ...
    liquidity += detect_session_levels(session_windows, bar_index)
    liquidity += detect_daily_levels(
        series.high, series.low, series.timestamps, bar_index,
    )
    liquidity += detect_weekly_levels(
        series.high, series.low, series.timestamps, bar_index,
    )
